...
var getCrewShip_1 = __importDefault(require("../../Utils/getCrewShip"));
// Import Get User Crew
var getUserCrew_1 = __importDefault(require("../../Utils/getUserCrew"));
// Export Function
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    ...
                    // Check Ship
                    if (!(crew_ship === null || crew_ship === void 0 ? void 0 : crew_ship.crewID))
                        return [2 /*return*/, newMember.setChannel(null, "Fuori dal Cazzo")];
                    return [2 /*return*/];
            }
        });
