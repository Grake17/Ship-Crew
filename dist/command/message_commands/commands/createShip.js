...
// Import Create Voice
var createVoice_1 = __importDefault(require("../../../Utils/Create Utils/createVoice"));
// Import Create Category
var createCategory_1 = __importDefault(require("../../../Utils/Create Utils/createCategory"));
// Import Create Text
var createText_1 = __importDefault(require("../../../Utils/Create Utils/createText"));
// Export Function
function create(mgs, db_objct, args) {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function () {
        var crew_role, crew, ship, embed;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    ...
                    // Send MGS
                    mgs.channel.send(embed).then(function (message) {
                        // Create Crew Ship
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            return [2 /*return*/, new Promise(function (resolve, rejects) { return __awaiter(_this, void 0, void 0, function () {
                    var IDS, category, text, x, voice;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                IDS = [];
                                return [4 /*yield*/, createCategory_1.default(mgs, crew)];
                            case 1:
                                category = _a.sent();
                                // Check Category
                                if (!category)
                                    return [2 /*return*/, rejects("Errore durante la creazione della categoria")];
                                return [4 /*yield*/, createText_1.default(mgs, crew, category)];
                            case 2:
                                text = _a.sent();
                                // Check Text
                                if (!text)
                                ...
                                _a.label = 3;
                            case 3:
                                if (!(x < 3)) return [3 /*break*/, 6];
                                return [4 /*yield*/, createVoice_1.default(mgs, crew, category)];
                            case 4:
                                voice = _a.sent();
                                // Check Voice
                                if (!voice)
